  ...
  const RITUELS_VISUELS = [
    {
      ...
      bullets: [
        ...
        "Rythme conseillé : 1 séance tous les 7 à 14 jours."
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        "Accompagner les déséquilibres menstruels (absence de règles, cycles irréguliers).",
        "Stimuler la circulation du bassin en soutien aux projets de grossesse.",
        "Décongestionner le bas-ventre et harmoniser le transit (ballonnements, constipation).",
        "Rythme conseillé : 1 à 2 séances par mois, adaptées aux phases du cycle."
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        "Relâcher les tensions de la mâchoire (bruxisme) et soulager les migraines.",
        "Rythme conseillé : 1 séance tous les 7 à 10 jours."
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        "Pour inscrire les bénéfices dans la durée, une séance d'entretien mensuelle est recommandée.",
        "Rythme conseillé : 1 séance toutes les 2 à 3 semaines."
      ],
              ...
              <div key={dbService.id} id={rituel.anchor} className="scroll-mt-32 group">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-primary/20 pb-6 mb-8">
                  <div className="md:w-2/3">
                    ...
                    <p className="font-body text-secondary text-sm font-bold uppercase tracking-widest mt-2">
                      {dbService.durationMin} MIN — {dbService.price} €
                    </p>
                  </div>
